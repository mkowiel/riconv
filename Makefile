...
install:
	...
	source activate tensorflow_p36 && cd ./tf_ops/3d_interpolation && bash tf_interpolate_compile.sh
	source activate tensorflow_p36 && cd ./tf_ops/grouping && bash tf_grouping_compile.sh
	source activate tensorflow_p36 && cd ./tf_ops/sampling && bash tf_sampling_compile.sh
